...
- [x] web 워크스페이스를 vercel을 사용해서 배포 해주세요.
...
- [x] 버튼 디바운스/ 스로틀링 시 로딩 애니메이션을 넣어주세요.
...
- `apps/web`: Next.js(App Router, TypeScript) 앱
- `apps/storybook`: Storybook 워크스페이스
- `packages/ui`: 공통 UI 컴포넌트 패키지
